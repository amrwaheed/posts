...
export class PostCreateComponent implements OnInit {
  ...
  onImagePicked(event : Event){
    ...
    this.form.patchValue({'image':file}) // call the single property of form [image] and assined to file
    this.form.get('image').updateValueAndValidity() // when change image value will be updated
